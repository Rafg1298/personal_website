  ...
  return (
    <div className="App">
      ...
      <body>
        ...
        <div className='about'>
          <img className='portrait' src='https://res.cloudinary.com/dxgndie5o/image/upload/c_limit,q_82,r_0,w_328/v1679037684/itsme-min_s38bgg.jpg' alt='A picture of me!'/> 
        ...
        <div className='social' >
          <a className='linked' href='https://www.linkedin.com/in/rileygolden/' target='_blank'>
        ...
        38.5-38.5 38.5zm282.1 243h-66.4V312c0-24.8-.5-56.7-34.5-56.7-34.6 0-39.9 27-39.9 54.9V416h-66.4V202.2h63.7v29.2h.9c8.9-16.8 30.6-34.5 62.9-34.5 67.2 0 79.7 44.3 79.7 101.9V416z"/></svg>
            ...
            <a className='git' href='#' target='_blank'>
